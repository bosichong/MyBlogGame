...
## 第一章：博客启蒙期（2001-2005）
var chapter1 = {
    "prologue_completed": false,      # 开场动画完成：2001年12月冬夜，收到云起网络邮件
    "blog_online": false,             # 博客正式上线：获得域名suiyan.cc和免费主机
    "first_article_posted": false,    # 第一篇博文发布：写下《你好，世界》
    "baidu_indexed": false,          # 百度首次收录：博客被搜索引擎发现
...
## 第二章：博客黄金期（2005-2010）
var chapter2 = {
    "literature_weekly": false,       # 文学周刊发布：分享文学作品，解锁3级文章
    "code_weekly": false,            # 程序员周刊发布：分享技术内容，解锁3级文章
...
var chapter3 = {
    ...
    "novel_planning": false,         # 小说连载规划：开始出书前的长篇创作准备
    "open_source_planning": false,   # 开源项目规划：开始开源前的项目规划
...
## 第四章：博客挑战期（2015-2020）
var chapter4 = {
    "novel_serial_start": false,     # 小说连载开始：创作长篇故事
    "paid_hacking": false,           # 付费黑客攻防发布：高级安全技术分享
    "book_invitation": false,        # 出版邀请：收到出版商邀请，进入出书流程
    "book_writing": false,           # 书籍撰写中：记录写作进度
    "book_published": false,         # 书籍出版完成：里程碑①，称号"作家"
    "open_source_start": false,      # 开源项目发布：贡献开源代码
    "open_source_recognized": false, # 开源获得认可：社区赞助商关注，称号"开发者"
