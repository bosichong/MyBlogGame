...
func decrease_blog_views(views, old_day, now_day,type) -> int:
...
func update_favorites(views,quality):
    var f = int(views*quality*0.1 / 1000)
    return f
